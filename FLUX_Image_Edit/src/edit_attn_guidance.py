"""
FLUX Image Editing with Attention-level Guidance (v2).

Applies guidance at each transformer layer by scoring text tokens
against image queries and blending cond/uncond K/V.
"""
...
def main(args):
    ...
    print(f"=== FLUX Attention Guidance (v2) ===")
    ...
    # Step 1: Inversion with source prompt
    ...
    # Step 2: Denoise with attention guidance
    inp_target["img"] = z
    ...
    print(f"Denoising time: {denoise_time:.1f}s")
    ...
    for xi in batch_x:
        ...
        fn = os.path.join(output_dir, f"attn_k{args.attn_k}_a{args.attn_alpha}_g{args.guidance}.jpg")
        exif_data = Image.Exif()
        exif_data[ExifTags.Base.Software] = "AI generated;txt2img;flux;attn_guidance"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='FLUX RF-Edit with Attention Guidance')
    ...
    parser.add_argument('--feature_path', type=str, default='feature_attn')
    parser.add_argument('--guidance', type=float, default=2.0)
    parser.add_argument('--num_steps', type=int, default=25)
    parser.add_argument('--inject', type=int, default=4)
    parser.add_argument('--output_dir', default='output_attn', type=str)

...
from hyvideo.diffusion.pipelines.pipeline_hunyuan_video_emb_guidance import HunyuanVideoEmbGuidancePipeline
from hyvideo.inference import Inference
import torch.nn.functional as F


class HunyuanVideoEditEmbGuidance(Inference):
    """
    ...
    def load_diffusion_pipeline(self, args, vae, text_encoder, text_encoder_2,
        ...
        pipeline = HunyuanVideoEmbGuidancePipeline(
    ...
    def predict(
        ...
        **kwargs,
        ...
        noise, info = self.pipeline(
            ...
            emb_guidance_alpha=0.0,  # No embedding guidance during inversion

"""PIE-Bench evaluation using SD3 attention guidance."""
import os, sys, json, time, io, argparse
import torch, numpy as np, pandas as pd
from PIL import Image
from sd3_attn_guidance import SD3AttnGuidanceEditor

def main(args):
    editor = SD3AttnGuidanceEditor(model_id=args.model_id, offload=args.offload)
        ...
        for idx in range(n):
            ...
            try:
                edited_img, elapsed = editor.edit(
                    ...
                    attn_k=args.attn_k, attn_alpha=args.attn_alpha,
                )
                ...
                json.dump({'source_prompt': source_prompt, 'target_prompt': target_prompt,
                           'category': cat, 'sample_id': sample_id, 'mode': 'attn_guidance',
                           'attn_k': args.attn_k, 'attn_alpha': args.attn_alpha,
...
if __name__ == "__main__":
    ...
    parser.add_argument('--attn_alpha', type=float, default=1.0)

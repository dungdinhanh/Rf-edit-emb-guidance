"""PIE-Bench eval for SD3 normalized + orthogonal embedding guidance."""
import os, json, time, io, argparse
import torch, numpy as np, pandas as pd
from PIL import Image
from sd3_edit_orthemb import SD3OrthEmbEditor

def main(args):
    editor = SD3OrthEmbEditor(model_id=args.model_id)
    ...
    method_name = f"orthemb_a{args.emb_alpha}"
        ...
        for idx in range(n):
            ...
            try:
                ...
                json.dump({'source_prompt': source_prompt, 'target_prompt': target_prompt,
                           'category': cat, 'sample_id': sample_id, 'mode': 'orthemb',

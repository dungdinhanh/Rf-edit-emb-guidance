"""PIE-Bench evaluation using SD3 hybrid guidance (emb + selective CFG)."""
import os, sys, json, time, io, argparse
import torch, numpy as np, pandas as pd
from PIL import Image
from sd3_edit_hybrid import SD3HybridEditor

def main(args):
    editor = SD3HybridEditor(model_id=args.model_id, offload=args.offload)

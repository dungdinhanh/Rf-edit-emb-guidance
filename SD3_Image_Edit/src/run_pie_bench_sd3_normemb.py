"""PIE-Bench evaluation for SD3 normalized embedding guidance."""
import os, json, time, io, argparse
import torch, numpy as np, pandas as pd
from PIL import Image
from sd3_edit_normemb import SD3NormEmbEditor

def main(args):
    editor = SD3NormEmbEditor(model_id=args.model_id)
    ...
    method_name = f"normemb_{args.norm_mode}_a{args.emb_alpha}"
        ...
        for idx in range(n):
            ...
            try:
                edited_img, elapsed = editor.edit(
                    ...
                    emb_alpha=args.emb_alpha, norm_mode=args.norm_mode,
                )
                ...
                json.dump({'source_prompt': source_prompt, 'target_prompt': target_prompt,
                           'category': cat, 'sample_id': sample_id, 'mode': 'normemb',
                           'norm_mode': args.norm_mode, 'emb_alpha': args.emb_alpha,
...
if __name__ == "__main__":
    ...
    parser.add_argument('--norm_mode', default='norm', choices=['none', 'norm', 'stats'])
